useGitSettings () {
    ...
    if [[ "${PWD##/d/Users/Adam/programming/Decker87}" != "$PWD" ]]; then
        ...
        echo "Using Gusto..."
    # Or work computer...
    elif [[ "${PWD##/Users/adam.schirmacher/workspace/Decker87}" != "$PWD" ]]; then
        export GIT_AUTHOR_NAME="Adam Schirmacher"
        export GIT_AUTHOR_EMAIL="decker.adam@gmail.com"
        export GIT_COMMITTER_NAME="$GIT_AUTHOR_NAME"
        export GIT_COMMITTER_EMAIL="$GIT_AUTHOR_EMAIL"
        export GIT_SSH_COMMAND="ssh -i /Users/adam.schirmacher/.ssh_personal/id_rsa"
        echo "Using Decker87..."
    elif [[ "${PWD##/Users/adam.schirmacher/workspace/Gusto}" != "$PWD" ]]; then
        export GIT_AUTHOR_NAME="Adam Schirmacher"
        export GIT_AUTHOR_EMAIL="adam.schirmacher@gusto.com"
        export GIT_COMMITTER_NAME="$GIT_AUTHOR_NAME"
        export GIT_COMMITTER_EMAIL="$GIT_AUTHOR_EMAIL"
        export GIT_SSH_COMMAND="ssh -i /Users/adam.schirmacher/.ssh_gusto/id_rsa"
        echo "Using Gusto..."
    else
